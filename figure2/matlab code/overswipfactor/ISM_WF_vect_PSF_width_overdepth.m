...
swipfactor=linspace(1.0,3.0,NNN);
...
OTF_im=imaging_scanning_pinhole_OTF_swipfactor(OTF_ex,OTF_em,OTF_pinhole,parameters,swipfactor(iii));
...
fn="D:\spin disk\figure new\figure2\new\overswipfactor\PSFs_width_oversizeof pinhole_vect.mat";
save(fn,'PSF_im_fitting_arr','PSF_em_fitting_arr','PSF_im_arr')
