...
pinhole_radius_at_imaging_plane=640*0.61*1.0/parameters.NA; % nm
...
if false
x_im=fit_2Dgaussian(XX,YY,PSF_conf);
...
x_im=FWHM_measure(PSF_conf);

x_em=FWHM_measure(PSF_em);

PSF_em_fitting_arr(1,iii)=x_em;
PSF_conf_fitting_arr(1,iii)=x_im;
%PSF_im_arr(:,:,iii)=PSF_conf;
end


fn="D:\spin disk\figure new\figure2\new\overdepth\confocal_PSFs_width_oversizeof pinhole_scalar.mat";
save(fn,'PSF_conf_fitting_arr','PSF_em_fitting_arr','T_efficiency')
