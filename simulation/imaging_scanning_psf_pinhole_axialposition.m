...
width_psf=zeros([2,NNN]);
rms=24.48*0;
fn="C:\research\spin disk\figure\axialandCRLB\PSFs_axial_pinhole_0ml_T_loss.mat";

zpos=linspace(0,500,NNN);
...
width_psf(1,iii)=x_im(3);
width_psf(2,iii)=x_em(3);
%disp(x_em(3)/x_im(3))
