...
Npupil=201;
NNN=10;
PSF_em_fitting_arr=zeros([512,512,NNN]);
PSF_im_fitting_arr=zeros([512,512,NNN]);
PSF_conf_fitting_arr=zeros([512,512,NNN]);

T_efficiency=zeros([1,NNN]);
%pinhole_radius_at_imaging_plane=640*0.61/1.33; % nm
pinhole_scale=linspace(0.3,2,11);
rms=24.48*0;
fn="C:\research\spin disk\simulation\PSF\PSFs_aberration_pinhole_0ml_T_loss.mat";

for iii=1:10
rms=24.48*3;
disp(iii);
pinhole_radius_at_imaging_plane=640*0.61*1.0/1.33; % nm
...
PSF_em_fitting_arr(:,:,iii)=PSF_em;
PSF_im_fitting_arr(:,:,iii)=PSF_im;
PSF_conf_fitting_arr(:,:,iii)=PSF_conf;
end
end


fn="C:\research\spin disk\figure\PSF_width_aberr\PSF_aberrated_wf_ims_confocal_108ml.mat";
%save(fn,'PSF_im_fitting_arr','PSF_em_fitting_arr','PSF_conf_fitting_arr')
